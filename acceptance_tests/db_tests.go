...
var _ = Describe("BillingSQLFunctions", func() {
	...
	It("Ignores app usage events triggered by tests", func() {
		...
		eventRawMessage, err := json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "SMOKE-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "ACC-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "CATS-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "PERF-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "BACC-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "AIVENBACC-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"task_name":                          nil,
			"space_guid":                         "c9bbfb98-9429-4c58-a57f-4304ef7f30a2",
			"space_name":                         "ASATS-1-SPACE-1c5968cee02f3899",
			"process_type":                       "web",
			"package_state":                      "STAGED",
			"buildpack_guid":                     "60b5ec15-3db4-4554-8cb0-4be2bcb64526",
			"buildpack_name":                     "binary_buildpack",
	...
	It("Correctly updates resources based on service usage events", func() {
		...
		eventRawMessage, err := json.Marshal(map[string]interface{}{
			...
			"space_name":            "test-SPACE-dc424ba9f99abbf5",
			"service_guid":          "7ab41178-f5a2-4444-b2f6-71abf43708b2",
			"service_label":         "postgres",
			"service_plan_guid":     "5eff64fa-8b41-4e6b-9321-b81624c678ce",
			"service_plan_name":     "tiny-unencrypted-12",
			"service_broker_guid":   "5cb906f6-ac20-4393-9210-e783fb4c8f39",
			"service_broker_name":   "rds-broker",
			"service_instance_guid": "c64e2c78-db40-44ae-987c-f2171fe5e42d",
			"service_instance_name": "BACC-4-test-db-74b2529697d9ed58",
		...
		eventRawMessage, err = json.Marshal(map[string]interface{}{
			...
			"org_guid":              "53d03a41-16a7-40a3-b1a9-83298e65f8f5",
			"space_guid":            "1cfdea3c-af34-4950-8383-5492e7c86c36",
			"space_name":            "test-4-SPACE-dc424ba9f99abbf5",
			"service_guid":          "7ab41178-f5a2-4444-b2f6-71abf43708b2",
			"service_label":         "postgres",
			"service_plan_guid":     "5eff64fa-8b41-4e6b-9321-b81624c678ce",
			"service_plan_name":     "tiny-unencrypted-12",
