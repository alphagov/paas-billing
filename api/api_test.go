...
var _ = Describe("API", func() {
	...
	var (
		...
		VeryCheapServicePlan = fixtures.Plan{
			ID:            4,
			Name:          "very-cheap-service-plan",
			ValidFrom:     time.Unix(0, 0),
			PlanGuid:      uuid.NewV4().String(),
			MemoryInMb:    8,
			StorageInMb:   16,
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						PriceExVAT:      30 * 60 * 4 * 100,
						PriceIncVAT:     int64(30 * 60 * 4 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						From:            monthsAgo(3),
						To:              monthsAgo(1),
						PriceExVAT:      ThreeMonthsInHours * (60 * 60) * 10 * 100,
						PriceIncVAT:     int64(ThreeMonthsInHours * (60 * 60) * 10 * 1.2 * 100),
					},
					{
						ResourceGuid:    "app",
						OrgGuid:         "org_guid",
						...
						From:            monthsAgo(1),
						To:              now,
						PriceExVAT:      OneMonthInHours * (60 * 60) * 4 * 100,
						PriceIncVAT:     int64(OneMonthInHours * (60 * 60) * 4 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						PriceExVAT:      30 * 60 * 4 * 1 * 100,
						PriceIncVAT:     int64(30 * 60 * 4 * 1 * 1.2 * 100),
					}, {
						ResourceGuid:    "app2",
						OrgGuid:         "org_guid2",
						...
						From:            now.Add(-90 * time.Minute),
						To:              now.Add(-30 * time.Minute),
						PriceExVAT:      60 * 60 * 4 * 2 * 100,
						PriceIncVAT:     int64(60 * 60 * 4 * 2 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						From:            now.Add(-60 * time.Minute),
						To:              now.Add(-30 * time.Minute),
						PriceExVAT:      30 * 60 * 4 * 2 * 100,
						PriceIncVAT:     int64(30 * 60 * 4 * 2 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						To:              now,
						PriceExVAT:      10 * 60 * 4 * 100,
						PriceIncVAT:     int64(10 * 60 * 4 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						To:              now,
						PriceExVAT:      720000,
						PriceIncVAT:     int64(7200 * 1.2 * 100),
					},
				},
			},
			{
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						PriceExVAT:      120000,
						PriceIncVAT:     int64(1200 * 1.2 * 100),
					},
					{
						ResourceGuid:    "service_instance1",
						OrgGuid:         "org_guid1",
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						From:            now.Add(-60 * time.Minute),
						To:              now.Add(-30 * time.Minute),
						PriceExVAT:      60 * 30 * 2 * 100,
						PriceIncVAT:     int64(60 * 30 * 2 * 1.2 * 100),
					},
				},
			}, {
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						PriceExVAT:      29 * 60 * 4 * 100,
						PriceIncVAT:     int64(29 * 60 * 4 * 1.2 * 100)},
					{
						ResourceGuid:    "service_instance1",
						OrgGuid:         "org_guid1",
						SpaceGuid:       "space_guid1",
						...
						To:              now.Add(-31 * time.Minute),
						PriceExVAT:      10 * 60 * 2 * 100,
						PriceIncVAT:     int64(10 * 60 * 2 * 1.2 * 100),
					},
				},
			}, {
				Name: "a single resource should be rounded up to 1p if less than 1p",
				ServiceEvents: []cf.UsageEvent{
					{
						MetaData: cf.MetaData{CreatedAt: now.Add(-20 * time.Minute)},
						EntityRaw: json.RawMessage(`{
							"state": "CREATED",
							"org_guid": "org_guid1",
							"space_guid": "space_guid1",
							"service_plan_guid": "` + VeryCheapServicePlan.PlanGuid + `",
							"service_instance_guid": "service_instance1",
							"service_instance_name": "db-service-1",
							"service_instance_type": "managed_service_instance"
						}`),
				...
				ExpectedOutput: []UsageEntry{
					{
						...
						OrgGuid:         "org_guid1",
						SpaceGuid:       "space_guid1",
						PricingPlanId:   VeryCheapServicePlan.ID,
						PricingPlanName: VeryCheapServicePlan.Name,
						MemoryInMb:      VeryCheapServicePlan.MemoryInMb,
						NumberOfNodes:   VeryCheapServicePlan.NumberOfNodes,
						StorageInMb:     VeryCheapServicePlan.StorageInMb,
						ResourceName:    "db-service-1",
