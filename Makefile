DATABASE_URL ?= postgres://postgres:galantGazelle12@localhost:5433/?sslmode=disable
TEST_DATABASE_URL ?= postgres://postgres:galantGazelle12@localhost:5433/?sslmode=disable
...
run-dev-exports:
	...
	$(eval export CF_CLIENT_SECRET=fP3WX1EPZYyE3KmlDvLrKIfyvzQmS5)
