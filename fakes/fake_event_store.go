...
type FakeEventStore struct {
	...
	GetPricingPlansStub        func(filter eventio.TimeRangeFilter) ([]eventio.PricingPlan, error)
	...
	GetCurrencyRatesStub        func(filter eventio.TimeRangeFilter) ([]eventio.CurrencyRate, error)
	...
	GetVATRatesStub        func(filter eventio.TimeRangeFilter) ([]eventio.VATRate, error)
...
func (fake *FakeEventStore) GetPricingPlans(filter eventio.TimeRangeFilter) ([]eventio.PricingPlan, error) {
...
func (fake *FakeEventStore) GetCurrencyRates(filter eventio.TimeRangeFilter) ([]eventio.CurrencyRate, error) {
	...
	fake.recordInvocation("GetCurrencyRates", []interface{}{filter})
	fake.getCurrencyRatesMutex.Unlock()
	if fake.GetCurrencyRatesStub != nil {
		return fake.GetCurrencyRatesStub(filter)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.getCurrencyRatesReturns.result1, fake.getCurrencyRatesReturns.result2
}
...
func (fake *FakeEventStore) GetCurrencyRatesArgsForCall(i int) eventio.TimeRangeFilter {
	fake.getCurrencyRatesMutex.RLock()
	defer fake.getCurrencyRatesMutex.RUnlock()
	return fake.getCurrencyRatesArgsForCall[i].filter
}
...
func (fake *FakeEventStore) GetVATRates(filter eventio.TimeRangeFilter) ([]eventio.VATRate, error) {
	...
	fake.recordInvocation("GetVATRates", []interface{}{filter})
	fake.getVATRatesMutex.Unlock()
	if fake.GetVATRatesStub != nil {
		return fake.GetVATRatesStub(filter)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.getVATRatesReturns.result1, fake.getVATRatesReturns.result2
}
...
func (fake *FakeEventStore) GetVATRatesArgsForCall(i int) eventio.TimeRangeFilter {
	fake.getVATRatesMutex.RLock()
	defer fake.getVATRatesMutex.RUnlock()
	return fake.getVATRatesArgsForCall[i].filter
}
